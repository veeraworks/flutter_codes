...
class _MapPageState extends State<MapPage> {
  ...
  Future<void> _listenStopsRealtime() async {
    ...
    _stopListener = FirebaseDatabase.instance
      ...
      data.forEach((key, value) {
        double lat = (value["lat"] as num).toDouble();
        double lng = (value["lng"] as num).toDouble();
  ...
  Future<void> _listenBusRealtime() async {
    ...
    _busListener = FirebaseDatabase.instance
      ...
      double lng = (map["lng"] as num).toDouble();
      ...
      // ✅ New polyline logic
      if (_studentStopLocation != null && _busLocation != null) {
        _drawRoute(_busLocation!, _studentStopLocation!);
      }
