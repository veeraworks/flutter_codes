...
Future<void> handleInitialMessage() async {
  ...
  if (initialMessage != null) {
    ...
    if (type == "ISSUE" || type == "TEMP_BUS_ACTIVE" || type == "TEMP_BUS_CLEARED") {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // ✅ Your bus image asset (the one you transferred)
              Image.asset(
                'assets/images/bus_icon.png', // make sure this matches your file name
                width: 400,
                height: 400,
                fit: BoxFit.contain,
              ),
